...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            {
                Debug.Log($"[PLAYER] Ingen SpawnPoint hittades, står kvar på scenens placering: {transform.position}");
            }
        }
    ...
    public void TakeDamage(int damage)
    {
        ...
        // Skadan f�r aldrig vara mindre �n 1
    ...
    {
        // Enkel exempel-logik: varje armor-niv� minskar skadan med t.ex. 10%
